...
window.translations.uk = {
  ...
  editBannerHint:
    'Скорочення: R P N W = зміна • O = надгодини • Ctrl+Z = скасувати • Ctrl+S = зберегти • Esc = вихід',
  undoBtn: '↶ Скасувати',
  redoBtn: '↷ Повторити',
  saveBtn: '💾 Зберегти',
  ...
  enableEditBody:
    'Кліки по комірках змінюватимуть зміни.<br><br>Виберіть зміну для "малювання" у палітрі внизу (або скорочення R/P/N/W).<br>Щоб додати <b>надгодини</b> — виберіть <b>⏱</b> (або клавішу O).<br><br>Зміни <b>НЕ зберігаються автоматично</b> — натисніть <b>💾 Зберегти</b>.',
  ...
  faqSaveNote:
    'Відпустки, надгодини й нотатки зберігаються автоматично. Регулярно робіть резервну копію через 📥 JSON, щоб не втратити дані після очищення браузера.',
  ...
  // === PRIVACY MODE ===
  menuPrivacyMode: 'Режим конфіденційності',
  privacyModeTitle: '🔒 Режим конфіденційності',
  privacyModeWarning:
    'Режим конфіденційності приховує всі ваші особисті дані (надгодини, відпустки, нотатки) у всіх видах. Буде видно лише заводський графік. Корисно для демонстрації екрана або показу графіка іншим.',
  privacyModeOn: 'Режим конфіденційності: УВІМК',
  privacyModeOff: 'Режим конфіденційності: ВИМК',
};
