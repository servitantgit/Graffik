...
window.translations.uk = {
  ...
  faqSyncDesc:
    'Google Drive — опційна резервна копія. За замовчуванням вимкнена, тож застосунок не запитує акаунт Google, доки ви самі її не увімкнете. Резервна копія та автоматична синхронізація — окремі опції: автоматична синхронізація є окремою опцією в Налаштування → Дані та приватність і вимкнена за замовчуванням. Коли вона вимкнена, застосунок не перевіряє Drive і не оновлює доступ у фоні; Drive використовується вручну через Завантажити / Надіслати. Токени доступу Google мають обмежений час життя, тому Google може попросити вхід, коли ви вручну обираєте операцію Drive.',
  faqSync1:
    'Відкрийте бічне меню → Google Drive і увімкніть «Резервна копія Google Drive». Потім натисніть Увійти. Той самий перемикач є в Налаштування → Дані та приватність. Автоматична синхронізація має окремий перемикач у Налаштування → Дані та приватність (вимкнено за замовчуванням).',
  ...
  faqSync4: 'При завантаженні даних застосунок запитує підтвердження перед перезаписом локальних даних.',
  faqSync5:
    'Вимкнення резервної копії Drive (або вихід) зупиняє запити логіну Google — вимкнена копія, як і раніше, повністю вимикає функцію Drive. Вимкнення лише автоматичної синхронізації теж зупиняє фонові перевірки й оновлення доступу, а ручні Завантажити / Надіслати продовжують працювати. Режим приватності (приховування особистих даних на екрані) не залежить від входу в Drive.',
  faqSyncNote:
