...
window.translations.uk = {
    ...
    editBannerHint: 'Скорочення: R P N W = зміна • O = понаднормові • Ctrl+Z = скасувати • Ctrl+S = зберегти • Esc = вихід',
    undoBtn: '↶ Скасувати',
    redoBtn: '↷ Повторити',
    saveBtn: '💾 Зберегти',
    ...
    enableEditBody: 'Кліки по комірках змінюватимуть зміни.<br><br>Виберіть зміну для "малювання" у палітрі внизу (або скорочення R/P/N/W).<br>Щоб додати <b>понаднормові</b> — виберіть <b>⏱</b> (або клавішу O).<br><br>Зміни <b>НЕ зберігаються автоматично</b> — натисніть <b>💾 Зберегти</b>.',
    ...
    clearYearBody: 'Буде видалено: збережені зміни + буфер для цього року. Відпустки та понаднормові залишаться. Заводські дані повернуться (якщо є).',
    ...
    otAfter: '⏱ ПІСЛЯ',
    otAdd: '+ Додати',
    otDeleteBefore: 'Видалити понаднормові ДО?',
    otDeleteAfter: 'Видалити понаднормові ПІСЛЯ?',
    otDeleteBtn: 'Видалити',
    otSaveBtn: '💾 Зберегти',
    otCancelBtn: 'Скасувати',
    otTitle: 'Понаднормові',
    otPositionBefore: 'ДО',
    ...
    otDeleted: 'Понаднормові видалено',
    otSelectHours: 'Виберіть кількість годин',
    otMonthSummary: '⏱ Понаднормові за місяць',
    otMonthEntry: 'запис',
    ...
    importReplaceBody: 'Імпорт перезапише ваші графіки, відпустки, понаднормові та нотатки.',
    ...
    faqViewsMonth: '📅 Місяць — головний календар. Тут видно зміни, вихідні дні, відпустки, нотатки, понаднормові й додаткові попапи з інформацією про попередню та наступну зміну.',
    ...
    faqOvertimeTitle: '⏱ Як додавати понаднормові?',
    ...
    faqOvertime3a: '⏱ ДО — понаднормові до зміни',
    faqOvertime3b: '⏱ ПІСЛЯ — понаднормові після зміни',
    faqOvertime4: 'Клікніть на попап і введіть кількість годин у модальному вікні',
    faqOvertimeCategory: 'Категорія понаднормових обчислюється автоматично:',
    faqOvertimeCat200: '+200% — якщо день святковий',
    faqOvertimeCat100: '+100% — коли понаднормові вночі (22:00–6:00) або в неділю',
    faqOvertimeCat50: '+50% — звичайні денні понаднормові',
    ...
    faqSaveNote: 'Відпустки, понаднормові й нотатки зберігаються автоматично. Регулярно робіть резервну копію через 📥 JSON, щоб не втратити дані після очищення браузера.',
    ...
    faqSync3: 'Синхронізуються: налаштування графіка, відпустки, понаднормові, нотатки та ліміти відпусток.',
