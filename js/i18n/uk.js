...
window.translations.uk = {
  ...
  faqOk: 'Зрозуміло',
  faqUiModeTitle: '🎛️ Чим відрізняється Простий режим від Розширеного?',
  faqUiModeDesc: 'Додаток має два режими інтерфейсу — вибирайте в Налаштуваннях → Режим інтерфейсу.',
  faqUiModeSimple: '🟢 Простий (для новачків) — календар, бригади, відпустки. Приховує рідше вживані функції: надгодини, нотатки, сповіщення, приватність, кастомні кольори.',
  faqUiModeAdvanced: '🔵 Розширений (для досвідчених) — всі функції: надгодини (до/після зміни, у вихідний), нотатки до днів, сповіщення про зміни, режим приватності, персоналізація кольорів R/P/N/U.',
  faqUiModeAutoDetect: '💡 При першому запуску додаток визначає чи у вас вже є дані (відпустки, надгодини, нотатки). Якщо так — залишаєтесь у Розширеному режимі. Якщо ні — починаєте з Простого.',
  ...
  faqStart4: 'Щоб змінити зміну, відпустку чи нотатку — відкрийте 📅 Місяць і торкніться потрібного дня',
  faqStartNote:
    'Особисті дані зберігаються в браузері; за бажанням синхронізуйте їх через Google Drive у меню. Заводський графік оновлюється з новою версією додатка.',
  faqLangTitle: '🌐 Як змінити мову додатка?',
  faqLangDesc: 'Мову змінюють у ☰ Меню → Налаштування → Загальні → Мова. Доступні:',
  faqLangPl: '🇵🇱 Польська',
  faqLangEn: '🇺🇸 English',
  ...
  faqViewsDashboard:
    '🏠 Панель — стартовий екран. Показує сьогоднішню зміну, найближчі дні, статус відпусток і швидкі переходи до інших видів. Триваюча після опівночі зміна N попереднього дня залишається активною (надгодини після зміни можуть її подовжити); опція дати — в Налаштування → Загальні.',
  faqViewsMonth:
  ...
  faqViewsYear:
    'Перемикач Місяць / Рік у панелі під вкладками розширює поточний вид (календар або таблицю) на весь рік.',
  faqViewsNote:
    'Навігація: стрілки ‹ › змінюють місяць або рік; «Сьогодні» повертає до поточної дати.',
  ...
  faqSkinTitle: '🎨 Як змінити вигляд додатка?',
  faqSkinDesc:
    '☰ Меню → Налаштування → Вигляд. Там є три рівні налаштувань:',
  faqSkinFull: 'Скін інтерфейсу — Industrial, Paper або Neon (загальний стиль програми).',
  faqSkinStrip: 'Таблиця — Стандарт (щільна сітка) або Капсула (заокруглені клітинки).',
  faqSkinQuiet:
    'Скін клітинок — повна заливка, смужка зліва або кольорове обведення рамки й дати.',
  faqSkinVacation:
    'Кольори змін R/P/N/U можна змінити окремо в тому ж розділі «Вигляд».',
  faqOvertimeTitle: '⏱ Як додавати надгодини?',
  faqOvertime1: 'Відкрийте 📅 Місяць і виберіть день зі зміною',
  faqOvertime2: 'У нижній панелі / попапах оберіть надгодини ⏱ (або клавішу O, якщо доступно)',
  ...
  faqSyncDesc:
    'Google Drive — це опційна резервна копія ваших особистих даних (відпустки, надгодини, нотатки, власні зміни). За замовчуванням вимкнена — застосунок не запитує акаунт Google, поки ви самі її не увімкнете.',
  faqSync1:
    'У боковому меню → блок Google Drive → увімкніть перемикач «Резервна копія Google Drive» і увійдіть.',
  faqSync2:
    'Усі налаштування синхронізації в одному місці: натисніть ⚙ Опції синхронізації в тому ж блоці. Відкриється панель з режимом синхронізації, порівнянням змін і кнопками Надіслати / Завантажити.',
  faqSync3:
    'Оберіть режим: Автоматична (фонові перевірки час від часу — може показувати вікна логування Google) або Тільки вручну (використовується лише коли натискаєте Надіслати або Завантажити — без фонових вікон Google). Рекомендовано ручний режим.',
  faqSync4:
    'Коли з\'являється попередження ⚠ в Drive card — натисніть на нього, щоб відкрити панель і побачити різницю між пристроєм і Drive.',
  faqSync5:
    'Вихід або вимкнення резервної копії: дані залишаються в цьому браузері, але більше не синхронізуються. Файл на Drive залишається — його можна видалити в налаштуваннях акаунта Google.',
  faqSyncNote:
    'Синхронізовані дані: відпустки, надгодини, нотатки, власні зміни, ліміти відпусток. Файл потрапляє лише у ваш приватний folder даних застосунку Google Drive. Повні деталі — Політика конфіденційності (privacy.html).',
  ...
  settingsTableDensity: 'Таблиця',
  settingsTableDensityDesc: 'Стандарт — щільна сітка. Капсула — заокруглені клітинки',
  tableDensityCompact: 'Стандарт',
  tableDensityComfortable: 'Капсула',
  ...
  persHint:
    'Особисті налаштування зберігаються на цьому пристрої й синхронізуються з Google Drive.',
  ...
  rangeMonth: 'Місяць',
  rangeYear: 'Рік',
  viewDashboardShort: 'Панель',
  viewMonthShort: 'Місяць',
  viewTableShort: 'Таблиця',
  menuSettingsDesc: 'Тема, мова, лічильники та дані',
  menuSectionTools: 'Інструменти',
  ...
  shareApplication: 'Додаток',
  shareContextPreview: 'Перегляд контексту',
  shareCopyCurrentLink: 'Копіювати посилання на вигляд',
  shareCopyAppLink: 'Копіювати посилання на додаток',
  exportCenterTitle: 'Експорт',
  exportIcsTitle: 'Календар ICS',
  exportIcsDesc: 'Завантажте графік у файлі ICS для Google Calendar, Outlook тощо.',
  printCurrentTitle: 'Друк',
  printCurrentDesc: 'Роздрукуйте поточний вигляд графіка',

  // === ABOUT ===
  aboutTitle: 'Про додаток',
  aboutDescription:
    'Графік змін для чотирьох бригад. Працює офлайн — ваші персональні дані залишаються на вашому пристрої.',
  aboutPrivacy: 'Приватність',
  aboutOffline: 'Працює офлайн',
  aboutVersion: 'Версія',
  ...
  dayActionVacationAdd: 'Додати відпустку',
  dayActionVacationRemove: 'Прибрати відпустку',
  dayActionExtraShift: 'Додаткова зміна',
  dayActionOvertimeBefore: 'Надгодини до зміни',
  dayActionOvertimeAfter: 'Надгодини після зміни',
  dayActionUnavailableFactoryShift: 'Цей день має заводську зміну',
  dayActionUnavailableNoShift: 'Цього дня немає зміни',
  dayActionUnavailableVacation: 'Цей день уже у відпустці',
  privacyDayDetailsHidden: 'Подробиці дня приховано в режимі приватності',
  privacyDisableAction: 'Вимкнути режим приватності',
  dayStatusShift: 'Зміна',
  dayStatusFree: 'Вихідний',
  dayStatusVacation: 'Відпустка',
  ...
  themeLight: 'Світла',
  themeDark: 'Темна',
  settingsReduceMotion: 'Зменшити анімації',
  settingsLargeText: 'Більший текст',
  settingsCompactCells: 'Компактні комірки',
  settingsLocalCounts: 'Ваші локальні дані',
  settingsPersonalShiftsCount: 'Особисті зміни: {n}',
  settingsVacationsCount: 'Відпустки: {n}',
  settingsOvertimesCount: 'Надгодини: {n}',
  settingsNotesCount: 'Нотатки: {n}',
  settingsFactoryDraftsCount: 'Чернетки заводського графіка: {n}',
  settingsClearPersonalData: 'Очистити персональні дані',
  settingsClearPersonalDataTitle: 'Очистити персональні дані?',
  settingsClearPersonalDataBody:
    'Ваші зміни, відпустки, надгодини та нотатки, збережені в цьому браузері, буде видалено. Заводський графік залишиться без змін.',
  settingsClearPersonalDataDone: '✅ Персональні дані очищено',
  settingsNotificationsSupported: 'Сповіщення підтримуються',
  settingsNotificationsUnsupported: 'Сповіщення не підтримуються',
  ...
  adminOverview: 'Огляд',
  adminFactoryEditor: 'Редактор заводського графіка',
  adminExportYear: 'Експорт року',
  adminGuide: 'Посібник',
  adminDangerZone: 'Небезпечна зона',
  factoryEditorTitle: 'Редактор заводського графіка',
  factoryEditorDraftHint:
    'Зміни зберігаються як чернетка — публічний заводський графік залишиться без змін до публікації.',
  factoryEditorExit: 'Завершити редагування',
  factoryEditorStart: 'Почати редагування',
  factoryEditorLocalDraftToast: '📝 Чернетку збережено локально',
  factoryEditorMigrationTitle: 'Перенести особисті зміни до чернетки?',
  factoryEditorMigrationBody:
    'Ваші особисті зміни цього року буде перенесено до чернетки заводського графіка, і вони більше не рахуватимуться як персональні дані.',
  factoryEditorStartFromFactory: 'Почати з заводського графіка',
  factoryEditorCopyPersonal: 'Копіювати особисті зміни',
  factoryEditorCancel: 'Скасувати',
  factoryDraftStatusPublic: 'Опубліковано',
  factoryDraftStatusDraft: 'Чернетка',
  factoryDraftClearYear: 'Очистити рік',
  factoryDraftClearYearTitle: 'Очистити чернетку року {year}?',
  factoryDraftClearYearBody:
    'Чернетку цього року буде видалено. Публічний заводський графік залишиться без змін.',
  factoryDraftResetAll: 'Скинути всі чернетки',
  factoryDraftResetAllTitle: 'Скинути всі чернетки?',
  factoryDraftResetAllBody:
    'Усі чернетки заводських графіків буде видалено. Публічний заводський графік залишиться без змін.',
  factoryDraftPublicUnaffected: 'Публічний заводський графік не змінюється',
  factoryDraftDiscarded: 'Чернетку відхилено',
  factoryDraftsReset: 'Усі чернетки скинуто',
  factoryExportDownloaded: 'Файл експорту завантажено',
  factoryExportInstructions:
    'Файл містить публічний графік року у форматі registerYearData. Його ще немає на сервері — потрібен деплой через git.',
  factoryExportDeployTitle: 'Інструкція з розгортання',
  factoryExportDeployIntro:
    'Файл {year}.js завантажено на ваш комп’ютер. Щоб графік став доступним усім користувачам додатка:',
  factoryExportDeployStepFile:
    'Скопіюйте {year}.js у каталог js/schedules/gillette/ у репозиторії (замініть файл, якщо рік уже існує).',
  factoryExportDeployStepIndex:
    'Лише для НОВОГО року: додайте в index.html рядок <script src="js/schedules/gillette/{year}.js"></script> одразу після інших річних файлів gillette.',
  factoryExportDeployStepCache:
    'Лише для НОВОГО року: додайте ./js/schedules/gillette/{year}.js до списку ASSETS у sw.js, щоб PWA закешувала файл офлайн.',
  factoryExportDeployStepCommit:
    'git add відповідні файли й commit (наприклад: chore(data): publish {year} factory schedule).',
  factoryExportDeployStepPush:
    'git push у гілку main. GitHub Actions збере сайт; користувачі отримають оновлення через Service Worker (toast «нова версія»).',
  factoryExportExistingYearHint:
    'Оновлення вже опублікованого року: достатньо замінити js/schedules/gillette/{year}.js. Не чіпайте index.html і sw.js, якщо script цього року вже підключений.',
  ...
  factoryEditorStep1: 'Оберіть рік у списку нижче',
  factoryEditorStep2: 'Натисніть «Почати редагування», щоб увімкнути режим малювання',
  factoryEditorStep3: 'Малюйте зміни клавішами R/P/N/W або кнопками панелі',
  factoryEditorStep4: 'Зміни автоматично зберігаються як чернетки',
  factoryEditorStep5: 'Коли все готово — експортуйте рік (вкладка «Експорт»), щоб підготувати публічний файл для всіх користувачів',
  factoryEditorSelectYear: 'Оберіть рік для редагування:',
  factoryEditorStatus: 'Статус: ',
  factoryEditorInactive: 'Неактивний',
  factoryEditorActive: 'Редактор активний — малюйте клавішами R/P/N/W',
  factoryEditorSelectTool: 'Оберіть інструмент',
  factoryEditorYear: 'Рік',
  factoryEditorMonth: 'Місяць',
  factoryEditorShift: 'Зміна',
  factoryEditorWorkflow: 'Типовий процес:',
  factoryDraftClearYearSuccess: 'Чернетку року {year} очищено',
  adminExportTitle: 'Експорт',
  adminExportDescription: 'Експорт збирає публічний заводський графік вибраного року (разом із вашими локальними чернетками адміна) у файл YYYY.js для розгортання в репозиторії.',
  adminExportHowItWorks: 'Як це працює:',
  adminExportStep1: 'Оберіть рік зі списку (доступні роки з даних + чернеток)',
  adminExportStep2: 'Натисніть «Експорт factory-року (.js)» — браузер завантажить файл',
  adminExportStep3: 'Додайте файл до репозиторію: js/schedules/gillette/YYYY.js; для нового року — також script у index.html і запис у sw.js; commit + push у main',
  adminExportSelectYear: 'Оберіть рік для експорту:',
  adminExportNoData: 'Немає даних для експорту',
  adminExportError: 'Помилка експорту',
  adminExportYearWithEdits: 'Містить ваші правки',
  adminExportYearFactory: 'Лише заводські дані',
  adminExportYearNew: 'Новий рік (лише власні дані)',
  adminGuideIntro: 'Адмін-центр керує заводським (публічним) графіком. Особисті зміни користувачів (відпустки, свої зміни) сюди не входять. Чернетки зберігаються лише локально, доки ви не експортуєте й не розгорнете файл.',
  adminGuideFactoryEditor: 'Редактор дозволяє малювати зміни R/P/N/W для всіх бригад. Усе пишеться в локальні чернетки factory drafts і не змінює опублікований графік, доки ви не зробите експорт і деплой.',
  adminGuideStep1: 'Увімкніть режим редагування для потрібного року',
  adminGuideStep2: 'Малюйте зміни клавішами R/P/N/W або кнопками панелі',
  adminGuideStep3: 'Зміни зберігаються локально як чернетки',
  adminGuideStep4: 'Експортуйте рік, коли будете готові публікувати: чернетки лишаються лише у вашому браузері; експорт збирає заводський графік (+ ваші чернетки) у файл YYYY.js для репозиторію',
  adminGuideStep5: 'Розгорніть експортований .js-файл: покладіть його в js/schedules/gillette/, за потреби додайте script у index.html і шлях у sw.js, зробіть commit і push у main — GitHub Pages опублікує оновлення, і всі користувачі побачать новий графік після оновлення додатка',
  adminGuideNavigateMonth: 'Перехід між місяцями',
  adminGuideExitEditor: 'Вийти з редактора',
  adminGuideExport: 'Експорт створює файл YYYY.js (формат registerYearData). Це не надсилає дані в Google Drive і не змінює сайт само по собі — файл потрібно додати в git і запушити, щоб GitHub Actions опублікував нову версію для всіх.',
  adminGuideDangerZone: 'Небезпечна зона очищає локальні чернетки або особисті дані. Це не видаляє вже опубліковані файли з репозиторію.',
  keyboardShortcuts: 'Гарячі клавіші',
  labelR: 'R — Ранок (6–14)',
  labelP: 'P — День (14–22)',
  labelN: 'N — Ніч (22–6)',
  labelW: 'W — Вихідний / очистити',
  adminDangerZoneWarning: 'Ці дії впливають на дані і їх важко скасувати.',
  adminDangerZoneTitle: '⚠️ Небезпечна зона',
  adminDangerZoneDesc: 'Дії в цій секції можуть назавжди змінити дані.',
  adminDangerZoneResetAllDesc: 'Видалити всі чернетки заводського графіка для всіх років.',
  adminDangerZoneClearYearDesc: 'Видалити чернетку заводського графіка для конкретного року.',
  adminDangerZoneResetPersonalDesc: 'Очистити всі особисті дані поточного користувача (графік, нотатки, відпустки тощо).',
  adminResetAllData: 'Скинути всі особисті дані',
  adminResetAllDataTitle: 'Скинути всі особисті дані?',
  adminResetAllDataBody: 'Буде очищено ВСІ ваші особисті дані (графік, нотатки, відпустки, понаднормові тощо). Цю дію неможливо скасувати.',
  adminResetPersonalDataSuccess: 'Особисті дані скинуто',
  adminResetPersonalDataError: 'Не вдалося скинути особисті дані',

  // === NOTES VIEW ===
  menuNotesView: 'Нотатки',
  menuNotesViewDesc: 'Всі нотатки в одному місці',
  notesViewTitle: '📝 Нотатки',
  notesSearchPlaceholder: 'Пошук у нотатках...',
  notesFilterMonth: 'Місяць',
  notesFilterBrigade: 'Бригада',
  notesFilterTag: 'Тип',
  notesFilterAll: 'Всі',
  notesFilterTagFree: 'Звичайні',
  notesFilterTagBefore: '⏱ До зміни',
  notesFilterTagAfter: '⏱ Після зміни',
  notesFilterDateFrom: 'Від',
  notesFilterDateTo: 'До',
  notesShowAll: 'Показати всі ({n})',
  notesShowRecent: 'Показати останні 30',
  notesEmpty: 'Немає нотаток',
  notesEmptyFiltered: 'Немає нотаток за фільтром',
  notesEmptyPlaceholder: '(порожня нотатка)',
