...
window.translations.uk = {
  ...
  faqSync5:
    'Вимкнення опції (або вихід) очищає локальний токен і зупиняє всі запити логіну Google. Режим приватності (приховування особистих даних на екрані) не залежить від входу в Drive.',
  faqSyncNote:
