...
window.translations.pl = {
    ...
    faqLangDesc: 'W górnym pasku jest przycisk 🌐 (flaga języka). Kliknięcie otwiera listę dostępnych języków:',
    faqLangPl: '🇵🇱 Polski',
    faqLangEn: '🇺🇸 English',
    faqLangUk: '🇺🇦 Українська',
    faqLangNote: 'Wybrany język zapisuje się automatycznie i jest przywracany przy kolejnym uruchomieniu. Przy pierwszym starcie język jest wykrywany z ustawień przeglądarki.',
