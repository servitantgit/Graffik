...
window.translations.pl = {
  ...
  infoNoteEditHint: 'Kliknij, aby edytować',
  infoShift: 'Zmiana',
  ...
  syncStatusStale: 'Nie udało się zweryfikować Google Drive — zaloguj się ponownie',
  driveCardStaleWarn: 'Nie udało się zweryfikować — dotknij, aby połączyć ponownie',
  ...
  // === NOTES VIEW ===
  menuNotesView: 'Notatki',
  menuNotesViewDesc: 'Wszystkie notatki w jednym miejscu',
  notesViewTitle: '📝 Notatki',
  notesSearchPlaceholder: 'Szukaj w notatkach...',
  notesFilterMonth: 'Miesiąc',
  notesFilterBrigade: 'Brygada',
  notesFilterTag: 'Typ',
  notesFilterAll: 'Wszystkie',
  notesFilterTagFree: 'Zwykłe',
  notesFilterTagBefore: '⏱ Przed zmianą',
  notesFilterTagAfter: '⏱ Po zmianie',
  notesFilterDateFrom: 'Od',
  notesFilterDateTo: 'Do',
  notesShowAll: 'Pokaż wszystkie ({n})',
  notesShowRecent: 'Pokaż ostatnie 30',
  notesEmpty: 'Brak notatek',
  notesEmptyFiltered: 'Brak notatek pasujących do filtra',
  notesEmptyPlaceholder: '(pusta notatka)',
