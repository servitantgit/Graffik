...
window.translations.en = {
    ...
    faqStartNote: 'Settings are saved automatically in the browser, so when you return to the app you return to the last state.',
    faqLangTitle: '🌐 How to change the app language?',
    faqLangDesc: 'In the top bar there is a 🌐 button (language flag). Clicking opens a list of available languages:',
    faqLangPl: '🇵🇱 Polish',
    faqLangEn: '🇺🇸 English (default)',
    faqLangUk: '🇺🇦 Ukrainian',
    faqLangNote: 'The selected language is saved automatically and restored on next launch. On first launch the language is auto-detected from browser settings.',
    ...
    faqViewsDashboard: '🏠 Dashboard — start screen. Shows today\'s shift, upcoming days, week summary, vacation status and quick links to other views.',
    faqViewsWeek: '📆 Week — shows the schedule for 7 days in a larger, more organized form, useful for planning the coming days.',
    faqViewsMonth: '📅 Month — main calendar. Here you can see shifts, days off, vacations, notes, overtime and additional popups with information about the previous and next shift.',
