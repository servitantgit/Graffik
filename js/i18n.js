...
const translations = {
  ...
  uk: {
    ...
    importReplaceBody: 'Імпорт перезапише ваші графіки, відпустки, переробки та нотатки.',
    ...
    faqViewsMonth: '📅 Місяць — головний календар. Тут ви бачите зміни, вихідні дні, відпустки, нотатки, переробки та додаткові випливаючі підказки з інформацією про попередню та наступну зміну.',
    ...
    faqSaveNote: 'Відпустки, переробки та нотатки зберігаються автоматично. Регулярно робіть резервну копію через 📥 JSON, щоб не втратити дані після очищення браузера.',
    ...
    faqSync3: 'Синхронізовані дані включають: налаштування графіка, відпустки, переробки, нотатки та ліміти відпустки.',
